...
EXPECTED_MODEL_ID = "CIDAS/clipseg-rd64-refined"
...
# Additional 40-hex revisions a document may legitimately cite: the FoodSeg103 parquet-conversion revision the
# sample is pinned to (samples.py CORPUS_REVISION).
KNOWN_SHAS: frozenset[str] = frozenset(("176acc3edd2432ee126bda6fb01469eadeb018df",))
...
EXPECTED_OUTPUTS = (
    "outputs/clipseg_segmentation_train.csv",
    "outputs/clipseg_segmentation_example_record.png",
    "outputs/clipseg_segmentation_input_manifest.json",
    "outputs/clipseg_segmentation_evaluation_report.json",
...
CODE_MARKERS = (
    ...
    "report = evaluation_report(result, scene_masks, sample_kind=",
...
MARKDOWN_MARKERS = (
    "**Capability:** zero-shot (text-prompted) image segmentation",
    "**Apache-2.0** licence",
    "**an uncalibrated per-pixel sigmoid**",
    "**the threshold is a caller-owned request parameter**",
    "**adaptation of the decoder on labelled (image, phrase, mask) records**",
...
EXTERNAL_WEIGHT_BYTES: dict[int, str] = {
    115_186_173: "dataset EduardoPacheco/FoodSeg103 176acc3 default/validation/0000.parquet",
    603_143_713: "CIDAS/clipseg-rd64-refined 999e032 pytorch_model.bin (not staged)",
}
EXTERNAL_WEIGHT_DIGESTS: dict[str, str] = {
    "d8123852b1f1c8dd7054c77ab36cf408738f48c7902678109d620165c2a6d4bf": "SAMPLE_DIGEST: dataset_digest over the 800-record FoodSeg103 default draw",
}
